...
CHANNEL_ID   = -1002000000000            # ← ЗАМЕНИ на числовой ID канала (см. инструкцию)
CHANNEL_LINK = "https://t.me/+WD8E6wCz8vA0ZDNi"  # пригласительная ссылка на канал
VERIFY_BOT   = "ИМЯ_VERIFY_БОТА"        # ← username бота-верификатора (без @)
ADMIN_IDS   = [8434813604, 8524655218]

WEBSITE_URL     = "https://example.com"            # ← замени на свой сайт
HOLD_FAQ_URL    = "https://example.com/hold-faq"   # ← страница «что такое холд»
SUPPORT_USERNAME = "@support"                       # ← поддержка
